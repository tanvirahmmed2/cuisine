      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white/5 border border-border rounded-3xl overflow-hidden">
          <div className="flex items-center justify-between p-5 px-6 border-b border-border">
            ...
            <Link href="/control/admin/tenants" className="text-xs text-primary hover:underline font-bold">View all →</Link>
          </div>
        ...
        <div className="bg-white/5 border border-border rounded-3xl overflow-hidden">
          <div className="flex items-center justify-between p-5 px-6 border-b border-border">
            ...
            <Link href="/control/admin/payments" className="text-xs text-primary hover:underline font-bold">View all →</Link>
          </div>
