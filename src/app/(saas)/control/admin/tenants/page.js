                ...
                {tenants.map((t) => (
                  <tr key={t.tenant_id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link href={`/control/admin/tenants/${t.tenant_id}`} className="inline-flex items-center justify-center px-4 py-2 bg-primary/10 text-primary hover:bg-primary hover:text-white rounded-lg text-xs font-bold transition-colors">
                        Manage →
                      </Link>
                    </td>
                  </tr>
