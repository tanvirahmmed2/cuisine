                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-xs text-slate-500 mt-2 space-y-1">
                      <div><strong className="text-slate-700">{pkg.max_menu_items}</strong> Max Menu Items</div>
                      <div><strong className="text-slate-700">{pkg.max_orders_per_month}</strong> Reservations/mo</div>
                    </div>
                  </div>
                )
              })}
