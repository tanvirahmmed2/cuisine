...
const Contact = async () => {
  ...
  if (!data.success || data.payload.length === 0) return (
    <div className='w-full h-64 flex flex-col items-center justify-center text-slate-400'>
      <p className="text-xl font-medium">No contact tickets found</p>
  ...
  return (
    <div className='w-full mx-auto p-4 space-y-4'>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-slate-800">Contact Inbox</h2>
      ...
      <div className="grid gap-4">
        {supports.map((info) => (
          <div key={info.id} className='w-full flex flex-row justify-between p-2 border rounded-lg'>
            ...
            <div className='flex-3 flex flex-col gap-3'>
              ...
              <div 
                className='font-semibold prose prose-sm prose-slate max-w-none'
