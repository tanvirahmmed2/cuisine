  ...
  try {
    ...
    if (Array.isArray(variants) && variants.length > 0) {
      for (const variant of variants) {
        await pool.query("INSERT INTO item_variants (item_id, name, value, price_adjustment, is_default) VALUES ($1, $2, $3, $4, $5)", [id, variant.name, variant.value, Number(variant.price_adjustment) || 0, variant.is_default || false]);
      }
    }
