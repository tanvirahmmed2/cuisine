                      ...
                      <button
                        ...
                        className={`group relative px-6 py-3 rounded-2xl text-sm font-bold transition-all duration-300 border ${
                          selectedVariants[groupName]?.id === v.id
                            ? 'bg-primary text-tertiary-light border-primary shadow-md scale-[1.02]'
                            : 'bg-tertiary-light text-tertiary-dark/70 border-tertiary-dark/20 hover:border-primary hover:bg-tertiary-dark/5'
                        }`}
                      >
