    ...
    <div className='w-full bg-tertiary-light rounded-[2rem] p-8 border border-primary/20 shadow-xl shadow-primary/5 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 h-full flex flex-col justify-between min-h-[220px]'>
      <div>
        <div className='flex items-center justify-between mb-6'>
          ...
          <div className='flex items-center gap-1 text-secondary font-bold text-xs bg-secondary/10 px-3 py-1 rounded-full'>
            <ArrowUpRight size={14} />
            <span>Active</span>
          </div>
        </div>
        
        <h3 className='text-sm font-bold text-tertiary-dark/60 uppercase tracking-wider mb-1'>{monthName} Sales</h3>
      ...
      <div className='grid grid-cols-2 gap-4 pt-4 border-t border-tertiary-dark/10'>
        ...
        <div>
          ...
          <p className='text-xs font-bold text-primary'>{currMonth + 1}/{currYear}</p>
        </div>
      </div>
    </div>
  )
